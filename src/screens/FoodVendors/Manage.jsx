...
import CompaniesForm from './FoodVendorForm';
...
const cards = [
    ...
    { name: 'Food', route: 'items', icon: 'bell-concierge', },
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        ...
                        {page === 'orders' && row.uuid && (
                            <CompaniesOrders {...props} orderStatus ={orderStatus} uuid={uuid} comp={row} setPage={page => setPage(page)} />
                        )}
