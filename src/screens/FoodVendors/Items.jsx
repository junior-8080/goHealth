...
class FoodVendorItems extends React.Component {
                    ...
                    <div className="col-12">
                        <div className="card shadow mb-4">
                            <div className="card-header py-3">
                                <h6 className="m-0 font-weight-bold text-primary float-left">Food Available</h6>
...
export default FoodVendorItems;