                            ...
                            <div className="row">
                                <div className="col-12 col-lg-6">
                                    <Form.Item colon={false} label="Name" name="name" rules={[{ required: true, message: 'This field is required' }]}>
                                        <Input autoComplete="off" size="large" placeholder="Item name" disabled={submitting} />
                                    </Form.Item>
                                </div>
                                <div className="col-12 col-lg-6">
                                ...
                                <div className="col-12 col-lg-6">
                                    <Form.Item colon={false} label="Discount (NGN)" name="discount" rules={[{ required: false, message: 'This field is required' }]}>
                                        <InputNumber type="number" autoComplete="off" size="large" placeholder="" disabled={submitting} />
                                    </Form.Item>
                                </div>
                                <div className="col-12 col-lg-6">
                                ...
                                <div className="col-12 col-lg-6">
                                    <Form.Item colon={false} label="Quantity" name="quantity" initialValue={1} rules={[{ required: true, message: 'This field is required' }]}>
                                        <InputNumber type="number" autoComplete="off" size="large" placeholder="" disabled={submitting} />
                                    </Form.Item>
                                </div>
                                <div className="col-12 col-lg-6">
                                ...
                                <div className="col-12 col-lg-12">
                                    <Form.Item colon={false} label="Description" name="description" rules={[{ required: true, message: 'This field is required' }]}>
                                        <Input.TextArea rows={5} autoComplete="off" size="large" placeholder="Item description" disabled={submitting} />
                                    </Form.Item>
                                </div>
                            </div>
                        </div>
