            ...
            <React.Fragment>
                        ...
                        <div className="row">
                            <div className="col-3">
                                <Select size="default" showSearch value={filter.status} onChange={status => this.setState({ filter: { ...filter, status } }, () => { this.getData() })}>
                                    ...
                                    {this.props.appointmentStatus.map((s) => (
                                        <Select.Option key={s.value} value={i.value}>{s.label}</Select.Option>
                                    ))}
                                </Select>
                            </div>
                ...
                <div className="card shadow mb-4">
                    <div className="card-header py-3">
                        <h6 className="m-0 font-weight-bold text-primary float-left">Appointments</h6>
