...
import CompaniesForm from './DoctorForm';
import CompaniesAddress from './Address';

import CompaniesSchedule from './Appointments';
import CompaniesOrders from './Appointments';
...
const cards = [
    ...
    { name: 'Prescriptions', route: 'prescriptions', icon: 'prescription-bottle', },
        // { name: 'Schedule', route: 'schedule', icon: 'calendar', },
    { name: 'Hospital', route: 'address', icon: 'map', },
];
            ...
            <Spin spinning={loading} indicator={func.fspinner_xs}>
                <div className="row">
                    ...
                    <div className="col-8">
                        ...
                        {page === 'appointments' && row.uuid && (
                            <CompaniesOrders {...props} uuid={uuid} comp={row} setPage={page => setPage(page)} appointmentStatus={appointmentStatus}/>
                        )}
                          {page === 'prescriptions' && row.uuid && (
                            <Prescription {...props} uuid={uuid} comp={row} setPage={page => setPage(page)}  />
                        )}
                        {row.uuid && (
                            <CompaniesForm
                                {...props}
